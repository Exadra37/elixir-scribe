defmodule Mix.Scribe.Context do
  ...
  @optional [
    ...
    # lib_web_domain_dir_plural: nil,
    lib_domain_dir: nil,
    # lib_domain_dir_plural: nil,
    ...
    # test_web_domain_dir_plural: nil,
    test_domain_dir: nil,
    # test_domain_dir_plural: nil,
  ...
  def type_spec() do
    schema(%__MODULE__{
      ...
      # test_web_domain_dir_plural: is_binary() |> spec(),
      test_domain_dir: is_binary() |> spec(),
      # test_domain_dir_plural: is_binary() |> spec(),
  ...
  def new!(context_name, schema, opts) do
    ...
    %Context{
      ...
      # test_web_domain_dir_plural: test_web_domain_dir_plural,
      test_domain_dir: test_domain_dir,
      # test_domain_dir_plural: test_domain_dir_plural,
