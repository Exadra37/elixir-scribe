defmodule ElixirScribe do
  ...
  * `delete` - Deletes an existing Resource
  ...
  Or, maybe you aren't doing CRUD style apps and you have a different set of actions to use by default:

  ```elixir
  config :elixir_scribe,
    default_resource_actions: ["invoice_paid", "product_ordered", "category_added"]
  ```
