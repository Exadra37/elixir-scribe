defmodule ElixirScribe.MixGenerator.Module.BuildName.BuildAbsoluteModuleActionName do
  ...
  defp base_module(context, [type: type]) when type in @core_resources, do: context.resource_module

  @web_resources [:lib_web, :controller, :controller_test, :test_web]
  defp base_module(context, [type: type]) when type in @web_resources, do: context.web_resource_module
end
