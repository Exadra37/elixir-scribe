defmodule ElixirScribe.Template.File.Inject.InjectEExTemplateBeforeModuleEnd do
  ...
  def inject(base_template_paths, source_path, target_path, binding) when is_list(base_template_paths) and is_binary(source_path) and is_binary(target_path) and is_list(binding) do
    base_template_paths
