defmodule ElixirScribe.Generator.SchemaResourceAPI do
  ...
  def default_param_value(%SchemaContract{} = contract, action) when is_atom(action), do:
    SchemaResourceHelpers.default_param(contract, action)
  ...
  def live_form_value(%NaiveDateTime{} = naive_datetime), do: SchemaResourceHelpers.live_form_value(naive_datetime)
